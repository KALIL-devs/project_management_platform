...
export async function POST(request: Request) {
  try {
    ...
    const existing = await prisma.roadmap.findUnique({ where: { clientId } });
    if (existing) {
      return NextResponse.json({ error: "Roadmap already exists for this client" }, { status: 400 });
    }
      ...
      },
      {
        ...
        modules: [
          ...
          },
          {
            ...
            description: "Day 70–85: Influencer, affiliates and community",
            order: 3,
            tasks: [
          ...
          },
          {
            ...
            description: "Day 75–90: Establish brand authority through PR",
            order: 4,
            tasks: [
